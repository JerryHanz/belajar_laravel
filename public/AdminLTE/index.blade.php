...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="{{URL::asset('#') }}">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{URL::asset('#') }}" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{URL::asset('#') }}" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="{{URL::asset('#') }}" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{URL::asset('#') }}" class="d-block">Alexander Pierce</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="{{URL::asset('#') }}" class="nav-link active">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="{{URL::asset('#') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="{{URL::asset('#') }}">
                        <img class="contacts-list-img" src="{{URL::asset('dist/img/user7-128x128.jpg') }}">
                    ...
                    <li>
                      <a href="{{URL::asset('#') }}">
                        <img class="contacts-list-img" src="{{URL::asset('dist/img/user3-128x128.jpg') }}">
                    ...
                    <li>
                      <a href="{{URL::asset('#') }}">
                        <img class="contacts-list-img" src="{{URL::asset('dist/img/user5-128x128.jpg') }}">
                    ...
                    <li>
                      <a href="{{URL::asset('#') }}">
                        <img class="contacts-list-img" src="{{URL::asset('dist/img/user6-128x128.jpg') }}">
                    ...
                    <li>
                      <a href="{{URL::asset('#') }}">
                        <img class="contacts-list-img" src="{{URL::asset('dist/img/user8-128x128.jpg') }}">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="pagination pagination-sm">
                    <li class="page-item"><a href="{{URL::asset('#') }}" class="page-link">&laquo;</a></li>
                    <li class="page-item"><a href="{{URL::asset('#') }}" class="page-link">1</a></li>
                    <li class="page-item"><a href="{{URL::asset('#') }}" class="page-link">2</a></li>
                    <li class="page-item"><a href="{{URL::asset('#') }}" class="page-link">3</a></li>
                    <li class="page-item"><a href="{{URL::asset('#') }}" class="page-link">&raquo;</a></li>
                  </ul>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu">
                      <a href="{{URL::asset('#') }}" class="dropdown-item">Add new event</a>
                      <a href="{{URL::asset('#') }}" class="dropdown-item">Clear events</a>
                      <div class="dropdown-divider"></div>
                      <a href="{{URL::asset('#') }}" class="dropdown-item">View calendar</a>
                    </div>
                  </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="{{URL::asset('http://adminlte.io">AdminLTE.io</a>.</strong>
    All rights reserved.
