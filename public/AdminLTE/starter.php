...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="{{URL::asset('#') }}" role="button"><i
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body">
                ...
                <a href="{{URL::asset('#') }}" class="card-link">Card link</a>
                <a href="{{URL::asset('#') }}" class="card-link">Another link</a>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="{{URL::asset('#') }}" class="btn btn-primary">Go somewhere</a>
              </div>
            </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2019 <a href="{{URL::asset('https://adminlte.io') }}">AdminLTE.io</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
